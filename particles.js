...
var fields = [
  new Field(new Vector(midX - 50, midY - 220), 850),
	new Field(new Vector(midX + 100, midY + 220), 850)
  //new Field(new Vector(midX - 100, midY - 200), 1200)
  /*new Field(new Vector(midX - 400, midY + 15), 800),
