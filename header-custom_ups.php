...
<!--BEGIN NEW HEADER CODE  PJC-->
  <script type="text/javascript"
		src="<?php get_template_directory_uri()?>/wp-content/themes/Consulting_Pro-child/js/draw-banner-ups.js"></script>
	<script type='text/javascript'>
		...
		//window.onload=function (){
			//debugger;
			//$message = "";
			// If msg > 70 chars use wordwrap()
			//$message = wordwrap($message, 70);
			// Send
			//mail('contact@carpentiertech.com', 'UPS PAGE LOAD', $message); 
		//};		
	</script>
	<?php mail('contact@carpentiertech.com','UPS PAGE LOAD','');?>
	<style> body { margin: 0px; } </style>
	<div id="canvas-container"; style="line-height: 0;">
		<img id="banner_logo"; style="position:absolute; width:100%;" src='<?php get_template_directory_uri()?>/wp-content/uploads/2017/12/UPS-Banner4.png';>
