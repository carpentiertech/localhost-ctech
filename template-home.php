...
get_header(custom2); ?>
	...
	<style>
		...
		.line-container1, .line-container3, .line-container5 {
			display: -webkit-box;
			display: -webkit-flex;
			display: -ms-flexbox;
			display: flex;
		...
		.div-block1L, .div-block1C, .div-block1R {
			-webkit-box-flex: 1;
			-webkit-flex: 1;
			-ms-flex: 1;
			flex: 1;
	...
	<div class="home-section">
		<div class="line-container1">
			<div class="div-block1L">
			</div> 
			<div class="div-block1C">
				Patrick Carpentier<br>Solutions Architect, IT Consultant, Engineer and Problem Solver Extraordinaire
			</div> 
			<div class="div-block1R">
				<img src="<?php get_template_directory_uri()?>/wp-content/uploads/2017/12/lhc-collision-small-blue.png" align="right" alt="">
			</div>
		</div>
		<br>
		...
		<div class="div-line3 line-container3">
		  <div class="div-block3L"><big>Do you have</big>
		    ...
		    <li>A state-wide system that needs to be running 24/7/365?</li>
				<li>Someone to help you realize and help design your goals?</li>
		    <li>An office that needs to be productive every day?</li>
				<li>New tools, solutions, processes or practices?</li>
		    <li>Or anything in between...</li></ul>
		  </div>
		  <div class="div-block3R"><big>Do you need</big>
		    <ul><li>An experienced IT consultant, team contributor or lead?</li>
		    <li>Someone to help you meet your goals and projects?</li>
				<li>One or many large projects that require professional experience?</li>
		...
		<div class="line-container4">
		  <div class="div-line4">Invite me to join your team; I'm confident that my experience, skills and work ethic will be a positive impact to your endeavors.</div>
		</div>
		<br>
		<div class="div-line5 line-container5">
		  <div class="div-block5L"><big>Experience</big>
			...
			<div class="div-block5C"><big>Skills</big>
			  <small><ul>
			  <li>Complex systems support, maintenance and troubleshooting</li>
			  <li>Solution Architect and Systems Integration</li>
			  <li>Server Admin (Windows, Exchange, Sharepoint, AD, HP-UX)</li>
			...
			<div class="div-block5R"><big>Values</big><br>
				<div style="padding-left: 12px; text-indent: -9px;"><small>Integrity</div>
				<div style="padding-left: 12px; text-indent: -9px;">Urgency</div>
				<div style="padding-left: 12px; text-indent: -9px;">Driven Work Ethic</div>
				<div style="padding-left: 12px; text-indent: -9px;">Application of Experience and Logic</div>
				<div style="padding-left: 12px; text-indent: -9px;">Philosophy of Constant Learning</div>
				<div style="padding-left: 12px; text-indent: -9px;">Open Communication</div>
				<div style="padding-left: 12px; text-indent: -9px;">Lead by Example</div>
				<div style="padding-left: 12px; text-indent: -9px;">Dedication (to Client, Company, End Users, those Impacted by Technology)</div>
				<div style="padding-left: 12px; text-indent: -9px;">Service to Others, Driven to Add Maximum Value</div>
				<div style="padding-left: 12px; text-indent: -9px;">Exceed Expectations</div></small>
			</div>
		</div>
		<br>
